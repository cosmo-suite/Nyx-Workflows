...
## Step 1
See the README in [CosmicIC](https://github.com/cosmo-suite/NyxCompilationAndRunning/tree/main/CosmicIC) - generating initial conditions for the dark matter particles. Required by all simulations.
